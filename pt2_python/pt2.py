...
def pt2_processor(events):
    ...
    ls_matches_two_hard_pls = (ls_matches_used_hard_pls_mask & ls_matches_unused_hard_pls_mask)
    ls_matches_two_pu_pls = (ls_matches_used_pu_pls_mask & ls_matches_unused_pu_pls_mask)
    ls_matches_used_hard_pls = (ls_matches_used_hard_pls_mask & (~ls_matches_two_hard_pls))
    ls_matches_unused_hard_pls = (ls_matches_unused_hard_pls_mask & (~ls_matches_two_hard_pls))
    ls_matches_used_pu_pls = (ls_matches_used_pu_pls_mask & (~ls_matches_two_pu_pls))
    ls_matches_unused_pu_pls = (ls_matches_unused_pu_pls_mask & (~ls_matches_two_pu_pls))
    ls_matches_none = (~(ls_matches_used_hard_pls_mask | ls_matches_used_pu_pls_mask | ls_matches_unused_hard_pls_mask | ls_matches_unused_pu_pls_mask))
    pls_matches_two_hard_ls = (pls_matches_used_hard_ls_mask & pls_matches_unused_hard_ls_mask)
    pls_matches_two_pu_ls = (pls_matches_used_pu_ls_mask & pls_matches_unused_pu_ls_mask)
    pls_matches_used_hard_ls = (pls_matches_used_hard_ls_mask & (~pls_matches_two_hard_ls))
    pls_matches_unused_hard_ls = (pls_matches_unused_hard_ls_mask & (~pls_matches_two_hard_ls))
    pls_matches_used_pu_ls = (pls_matches_used_pu_ls_mask & (~pls_matches_two_pu_ls))
    pls_matches_unused_pu_ls = (pls_matches_unused_pu_ls_mask & (~pls_matches_two_pu_ls))
    pls_matches_none = (~(pls_matches_used_hard_ls_mask | pls_matches_used_pu_ls_mask | pls_matches_unused_hard_ls_mask | pls_matches_unused_pu_ls_mask))
    ...
    plot_objects = {
        ...
        "ls_used_real_simIdxmacthes_pls_hard_used_pt": events.ls_pt[real_used_ls_mask & ls_matches_used_hard_pls],
        "ls_used_real_simIdxmacthes_pls_hard_used_eta": events.ls_eta[real_used_ls_mask & ls_matches_used_hard_pls],
        "ls_used_real_simIdxmacthes_pls_hard_used_phi": events.ls_phi[real_used_ls_mask & ls_matches_used_hard_pls],
        "ls_used_real_simIdxmacthes_pls_hard_unused_pt": events.ls_pt[real_used_ls_mask & ls_matches_unused_hard_pls],
        "ls_used_real_simIdxmacthes_pls_hard_unused_eta": events.ls_eta[real_used_ls_mask & ls_matches_unused_hard_pls],
        "ls_used_real_simIdxmacthes_pls_hard_unused_phi": events.ls_phi[real_used_ls_mask & ls_matches_unused_hard_pls],
        ...
        "ls_used_real_simIdxmacthes_two_pls_hard_pt": events.ls_pt[real_used_ls_mask & ls_matches_two_hard_pls],
        "ls_used_real_simIdxmacthes_two_pls_hard_eta": events.ls_eta[real_used_ls_mask & ls_matches_two_hard_pls],
        "ls_used_real_simIdxmacthes_two_pls_hard_phi": events.ls_phi[real_used_ls_mask & ls_matches_two_hard_pls],
        ...
        "ls_unused_real_simIdxmacthes_pls_hard_used_pt": events.ls_pt[real_unused_ls_mask & ls_matches_used_hard_pls],
        "ls_unused_real_simIdxmacthes_pls_hard_used_eta": events.ls_eta[real_unused_ls_mask & ls_matches_used_hard_pls],
        "ls_unused_real_simIdxmacthes_pls_hard_used_phi": events.ls_phi[real_unused_ls_mask & ls_matches_used_hard_pls],
        "ls_unused_real_simIdxmacthes_pls_hard_unused_pt": events.ls_pt[real_unused_ls_mask & ls_matches_unused_hard_pls],
        "ls_unused_real_simIdxmacthes_pls_hard_unused_eta": events.ls_eta[real_unused_ls_mask & ls_matches_unused_hard_pls],
        "ls_unused_real_simIdxmacthes_pls_hard_unused_phi": events.ls_phi[real_unused_ls_mask & ls_matches_unused_hard_pls],
        ...
        "ls_unused_real_simIdxmacthes_two_pls_hard_pt": events.ls_pt[real_unused_ls_mask & ls_matches_two_hard_pls],
        "ls_unused_real_simIdxmacthes_two_pls_hard_eta": events.ls_eta[real_unused_ls_mask & ls_matches_two_hard_pls],
        "ls_unused_real_simIdxmacthes_two_pls_hard_phi": events.ls_phi[real_unused_ls_mask & ls_matches_two_hard_pls],
        ...
        "pls_used_real_simIdxmacthes_ls_hard_used_pt": events.pls_pt[real_used_pls_mask & pls_matches_used_hard_ls],
        "pls_used_real_simIdxmacthes_ls_hard_used_eta": events.pls_eta[real_used_pls_mask & pls_matches_used_hard_ls],
        "pls_used_real_simIdxmacthes_ls_hard_used_phi": events.pls_phi[real_used_pls_mask & pls_matches_used_hard_ls],
        "pls_used_real_simIdxmacthes_ls_hard_unused_pt": events.pls_pt[real_used_pls_mask & pls_matches_unused_hard_ls],
        "pls_used_real_simIdxmacthes_ls_hard_unused_eta": events.pls_eta[real_used_pls_mask & pls_matches_unused_hard_ls],
        "pls_used_real_simIdxmacthes_ls_hard_unused_phi": events.pls_phi[real_used_pls_mask & pls_matches_unused_hard_ls],
        ...
        "pls_used_real_simIdxmacthes_two_ls_hard_pt": events.pls_pt[real_used_pls_mask & pls_matches_two_hard_ls],
        "pls_used_real_simIdxmacthes_two_ls_hard_eta": events.pls_eta[real_used_pls_mask & pls_matches_two_hard_ls],
        "pls_used_real_simIdxmacthes_two_ls_hard_phi": events.pls_phi[real_used_pls_mask & pls_matches_two_hard_ls],
        ...
        "pls_unused_real_simIdxmacthes_ls_hard_used_pt": events.pls_pt[real_unused_pls_mask & pls_matches_used_hard_ls],
        "pls_unused_real_simIdxmacthes_ls_hard_used_eta": events.pls_eta[real_unused_pls_mask & pls_matches_used_hard_ls],
        "pls_unused_real_simIdxmacthes_ls_hard_used_phi": events.pls_phi[real_unused_pls_mask & pls_matches_used_hard_ls],
        "pls_unused_real_simIdxmacthes_ls_hard_unused_pt": events.pls_pt[real_unused_pls_mask & pls_matches_unused_hard_ls],
        "pls_unused_real_simIdxmacthes_ls_hard_unused_eta": events.pls_eta[real_unused_pls_mask & pls_matches_unused_hard_ls],
        "pls_unused_real_simIdxmacthes_ls_hard_unused_phi": events.pls_phi[real_unused_pls_mask & pls_matches_unused_hard_ls],
        ...
        "pls_unused_real_simIdxmacthes_two_ls_hard_pt": events.pls_pt[real_unused_pls_mask & pls_matches_two_hard_ls],
        "pls_unused_real_simIdxmacthes_two_ls_hard_eta": events.pls_eta[real_unused_pls_mask & pls_matches_two_hard_ls],
        "pls_unused_real_simIdxmacthes_two_ls_hard_phi": events.pls_phi[real_unused_pls_mask & pls_matches_two_hard_ls],
